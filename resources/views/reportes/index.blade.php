    ...
    <div class="col-md-3">
        <div class="card stat-card stat-card-primary">
            <div class="card-body">
                ...
                <div class="fs-4 fw-bold">{{ $kpis['ventas_hoy'] ?? 0 }}</div>
                <div class="small text-muted">S/ {{ number_format($kpis['monto_hoy'] ?? 0, 2) }}</div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card stat-card stat-card-success">
            <div class="card-body">
                ...
                <div class="fs-4 fw-bold">{{ $kpis['ventas_mes'] ?? 0 }}</div>
                <div class="small text-muted">S/ {{ number_format($kpis['monto_mes'] ?? 0, 2) }}</div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card stat-card stat-card-secondary">
            <div class="card-body">
                ...
                <div class="fs-4 fw-bold">{{ $kpis['clientes_activos'] ?? 0 }}</div>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card stat-card stat-card-warning">
            <div class="card-body">
                ...
                <div class="fs-4 fw-bold">{{ $kpis['productos_activos'] ?? 0 }}</div>
            </div>
        </div>
    </div>
</div>
...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.flujo.caja') }}" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.resumen.diario') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow border-primary">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.libro.ventas') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.productos.mas.vendidos') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.por.categoria') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.por.vendedor') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.por.metodo.pago') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.diario') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.mensual') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.igv') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.stock.critico') }}" class="text-decoration-none">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.top.clientes') }}" class="text-decoration-none">
            <div class="card h-100 text-center hover-shadow">
                <div class="card-body">
    ...
    <div class="col-md-4">
        <a href="{{ route('reportes.margen.ganancia') }}" class="text-decoration-none">
