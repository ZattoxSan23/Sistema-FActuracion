                    ...
                    <tbody>
                        @forelse($categorias as $cat)
                            <tr>
                                ...
                                <td class="text-center"><span class="badge bg-secondary">{{ $cat->productos_count }}</span></td>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline-primary" onclick="editarCategoria({{ $cat }})">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <form action="{{ route('categorias.destroy', $cat) }}" method="POST" class="d-inline" onsubmit="return confirm('¿Eliminar?')">
                                        @csrf
                                        @method('DELETE')
